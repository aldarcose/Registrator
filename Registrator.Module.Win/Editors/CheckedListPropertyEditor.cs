...
namespace Registrator.Module.Win.Editors
{
    ...
    public class CheckedListPropertyEditor : WinPropertyEditor, IComplexViewItem
    {
        public CheckedListPropertyEditor(Type objectType, IModelMemberViewItem model) : base(objectType, model) { }
