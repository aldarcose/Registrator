...
namespace Registrator.Module.Win.Controllers
{
    ...
    public partial class PolisDynamicMaskChangeController : ViewController
    {
        public PolisDynamicMaskChangeController()
        {
            InitializeComponent();
        ...
        void propertyEditor_ControlValueChanged(object sender, EventArgs e)
        {
            ...
            PropertyEditor propertyEditorSerial = ((DetailView)View).FindItem("Serial") as PropertyEditor;
            PropertyEditor propertyEditorNumber = ((DetailView)View).FindItem("Number") as PropertyEditor;

            var value = propertyEditorType.ControlValue as Registrator.Module.BusinessObjects.Dictionaries.VidPolisa;
