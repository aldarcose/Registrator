...
namespace Registrator.Module.BusinessObjects.Dictionaries
{
    ...
    public class V004 : BaseObject
    {
        ...
        public V004() : base() { }
        public V004(Session session) : base(session) { }
        ...
        public static void UpdateDbFromXml(DevExpress.ExpressApp.IObjectSpace objSpace, string xmlPath)
        {
            ...
            foreach (var element in doc.Root.Elements())
            {
                ...
                V004 obj = objSpace.FindObject<V004>(DevExpress.Data.Filtering.CriteriaOperator.Parse("Code=?", element.Attribute(code_attr).Value));
                if (obj == null)
                {
                    obj = objSpace.CreateObject<V004>();
