...
namespace Registrator.Module.BusinessObjects.Dictionaries
{
    ...
    /// </summary>
    [DefaultClassOptions]
    public class FormaMedPomoshi : BaseObject
    {
        // пример записи в XML:
        // <zap IDFRMMP="1" FRMMPNAME="Экстренная" DATEBEG="01.01.2013" DATEEND="" />
        // <zap IDFRMMP="2" FRMMPNAME="Неотложная" DATEBEG="01.01.2013" DATEEND="" />

        public FormaMedPomoshi() : base() { }
        public FormaMedPomoshi(Session session) : base(session) { }
        ...
        public static void UpdateDbFromXml(DevExpress.ExpressApp.IObjectSpace objSpace, string xmlPath)
        {
            ...
            const string code_attr = "IDFRMMP";
            const string name_attr = "FRMMPNAME";
            ...
            foreach (var element in doc.Root.Elements())
            {
                ...
                FormaMedPomoshi obj = objSpace.FindObject<FormaMedPomoshi>(DevExpress.Data.Filtering.CriteriaOperator.Parse("Code=?", element.Attribute(code_attr).Value));
                if (obj == null)
                {
                    obj = objSpace.CreateObject<FormaMedPomoshi>();
