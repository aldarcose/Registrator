...
{
    /// <summary>
    /// Классификатор ведомственной принадлежности МО
    /// </summary>
    public class F007 : BaseObject
    {
        // пример записи в XML:
        // <rec1 IDVED="1" VEDNAME="Муниципального образования" DATEBEG="01.01.2011" DATEEND="" />
        // <rec2 IDVED="2" VEDNAME="Субъекта Российской Федерации" DATEBEG="01.01.2011" DATEEND="" />
        // <rec3 IDVED="4" VEDNAME="Минобрнауки России" DATEBEG="01.01.2011" DATEEND="" />

        public F007() : base() { }
        public F007(Session session) : base(session) { }
        ...
        public static void UpdateDbFromXml(DevExpress.ExpressApp.IObjectSpace objSpace, string xmlPath)
        {
            ...
            const string code_attr = "IDVED";
            const string name_attr = "VEDNAME";
            ...
            foreach (var element in doc.Root.Elements())
            {
                ...
                F007 obj = objSpace.FindObject<F007>(DevExpress.Data.Filtering.CriteriaOperator.Parse("Code=?", element.Attribute(code_attr).Value));
                if (obj == null)
                {
                    obj = objSpace.CreateObject<F007>();
